...
import type { ScalarGetter, SoaValue } from "../value.js";

function vectorLength(value: SoaValue): number {
...
/** `ParticleVectorLengthBlock` (SoA) — return the magnitude of a scalar, vector, or color. */
export const particleVectorLengthBlock: SoaBlockEvaluator = {
    build(block, ctx) {
