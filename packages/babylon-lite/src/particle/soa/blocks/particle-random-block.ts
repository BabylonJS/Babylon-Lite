...
export function createRandomDraw(minGetter: SoaGetter, maxGetter: SoaGetter): SoaGetter {
...
/**
 * `ParticleRandomBlock` (SoA) — a random value with a lock controlling re-draw frequency. `PerParticle`
 ...
 */
export const particleRandomBlock: SoaBlockEvaluator = {
    build(block, ctx) {
