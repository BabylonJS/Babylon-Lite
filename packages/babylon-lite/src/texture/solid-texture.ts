...
import type { SampledTexture } from "./texture-2d.js";
import type { EngineContext } from "../engine/engine.js";
import type { EngineContextInternal } from "../engine/engine.js";
import { getBilinearSampler } from "../resource/gpu-pool.js";

export function createSolidTexture2D(engine: EngineContext, r: number, g: number, b: number, a: number = 1.0): SampledTexture {
