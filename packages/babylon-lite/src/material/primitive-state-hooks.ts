...
export let _primitiveState:
    readonly [(mesh: Mesh) => number, (meshFeatures: number, hasDoubleSided: boolean) => GPUPrimitiveState, (meshFeatures: number) => GPUFrontFace] | undefined;
