 ...
 * loaded lazily on the first call, so engines whose surfaces never capture a screenshot
 * ship none of it and keep a plain, compression-friendly RENDER_ATTACHMENT swapchain.
 */
