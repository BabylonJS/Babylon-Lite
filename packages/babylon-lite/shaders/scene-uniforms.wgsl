// Unified SceneUniforms — shared by every non-shadow render pass.
// Layout total: 416 bytes. Offsets are mirrored in scene-uniforms-fields.ts;
// keep both sides in sync if you change this struct.
