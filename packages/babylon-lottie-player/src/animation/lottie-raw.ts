...
export interface Layer {
    ...
    refId?: string;
    /** Layer masks. Each clips the layer's content to a path region. */
...
export interface Asset {
    ...
    p?: string;
    /** Directory prefix for external images. The full worker resolves it from a URL-loaded JSON
     *  document; parsed documents must provide an absolute prefix. */
    u?: string;
