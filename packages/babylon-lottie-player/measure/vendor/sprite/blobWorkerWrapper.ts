...
export class BlobWorkerWrapper {
     ...
     * @param url The URL of the worker script that needs to be wrapped into a blob.
     */
    ...
    /**
     * Gets the underlying Worker instance created by this BlobWorkerWrapper.
     * @returns The underlying Worker instance created by this BlobWorkerWrapper.
     */
