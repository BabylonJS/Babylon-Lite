...
| Meshes & geometry (class chain, `MeshBuilder` primitives, transforms, thin instances, `VertexData`)       |   ⚡   | `CreateLines`/`CreateDecal`/`CreateText`/`CreateTiledBox`/`CreateTiledPlane`, `InstancedMesh`, LOD/edges/outline, clone/instance unsupported                                                                  |
