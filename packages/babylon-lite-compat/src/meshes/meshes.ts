...
export class Mesh extends AbstractMesh {
     ...
     * tangents or a second UV set (Lite would have to drop them). Skeleton skinning
     * is not carried.
     */
    public static MergeMeshes(
        ...
        for (const mesh of sources) {
            const lite = mesh._lite as { _cpuColors?: unknown; _cpuTangents?: unknown; _cpuUv2s?: unknown };
