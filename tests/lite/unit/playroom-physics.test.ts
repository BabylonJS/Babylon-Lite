...
const bounds = {
    ...
    popper: { center: [0, 0.14529758401214796, 0], extents: [0.149379163980484, 0.2905952392528448, 0.149379163980484] },
    ...
    cup: { center: [0, 0.20513648092746717, 0], extents: [0.3989320993423462, 0.4102730095386505, 0.3989320993423462] },
    domino: { center: [0, 0.1500000014901161, 0], extents: [0.15000000596046448, 0.3000000208616257, 0.03750000149011612] },
    ramp: { center: [0.0570751428604126, 0.4741147816181183, 8.940696716308594e-8], extents: [2.488025426864624, 0.9482296586036681, 0.8898646235466003] },
    towerGameBlock: { center: [0, 0.14999999105930328, 0], extents: [0.4999999701976776, 0.29999998211860657, 1.4999998807907104] },
    transformedTowerGameBlock: { center: [0, -(2 ** -25), 2.2351741790771484e-8], extents: [0.4999999403953552, 1.5000001788139343, 0.30000023543834686] },
