...
import { createOnceRandomGetter } from "../../../packages/babylon-lite/src/particle/soa/blocks/particle-random-once";
import { createTypedOnceRandomGetter } from "../../../packages/babylon-lite/src/particle/soa/blocks/particle-random-once-typed";
import { createParticleBuffer } from "../../../packages/babylon-lite/src/particle/soa/particle-buffer";

describe("SoA OncePerParticle random cache", () => {
