/**
 * Scene 246 — RecursiveSkeletons (cx20 gltf-test parity).
 */
...
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene246-recursive-skeletons");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 246 skipped via skipParity in scene-config.json");

test("Scene 246 — RecursiveSkeletons matches Babylon.js reference", async ({ page }, testInfo) => {
