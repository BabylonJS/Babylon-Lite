...
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene243-emissive-fireflies");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 243 skipped via skipParity in scene-config.json");

test("Scene 243 — EmissiveFireflies matches Babylon.js reference", async ({ page }, testInfo) => {
