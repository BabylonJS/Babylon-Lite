/**
 * Scene 261 — Frame-graph Temporal Anti-Aliasing Parity Test
 *
 * Captures the Babylon Lite TAA post-process chain and compares it against a
 * Babylon.js reference scene using `TAARenderingPipeline`.
 *
 * Assertions:
 * - Full image MAD stays within the scene-config threshold after TAA convergence.
 */
