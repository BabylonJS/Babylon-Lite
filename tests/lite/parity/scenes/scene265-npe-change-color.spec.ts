...
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene265-npe-change-color");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 265 skipped via skipParity in scene-config.json");

test("Scene 265 — NPE particle system (Change - Color) matches Babylon.js reference", async ({ page }, testInfo) => {
