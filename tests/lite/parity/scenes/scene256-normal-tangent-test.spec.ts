/**
 * Scene 256 — NormalTangentTest (cx20 gltf-test / Khronos glTF-Sample-Assets parity).
 */
import { test, expect } from "../parity-fixtures";
import * as path from "path";
import { attachCompareArtifacts, captureGolden, compareImages, getSceneConfig } from "../compare-utils";

const sceneConfig = getSceneConfig(256);
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene256-normal-tangent-test");
