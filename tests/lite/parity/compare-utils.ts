...
export { compareImages, compareImageRects, compareRegion, generateDiffMap, attachCompareArtifacts, shouldSkipParity, waitForCanvasReady } from "../../shared/compare-core";
export type { SceneConfig, CompareRect, CompareResult, RegionResult, CaptureGoldenOptions } from "../../shared/compare-core";
