...
- the exact Trogir startup orbit formats as the specified six-field HUD pose, and orbit-to-first-person-to-orbit conversion preserves world eye, normalized look direction, FOV, near, and far while control attachment has one active cleanup at a time;
