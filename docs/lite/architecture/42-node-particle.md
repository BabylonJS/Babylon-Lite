...
Bundle output and per-scene manifests are generated and ignored. One filtered build generated exactly scenes 262, 263, 264, 276, 277, 280, 281, 283, 284, 302, and 305. A detached same-environment build at reviewed Phase 3B checkpoint `37ac466e93b2842337248901955c4fc4b195096e` supplied the comparison totals for the same fixture before its conflict-driven renumber from 304 to 305:
