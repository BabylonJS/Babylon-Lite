// Scene 307: LWR Physics with Parent Nodes
...
async function main(): Promise<void> {
    ...
    scene.camera = createFreeCamera({ x: OFFSET - 2, y: 8, z: OFFSET - 16 }, { x: OFFSET, y: 0, z: OFFSET });
    ...
    cube1.position.set(OFFSET - 6, 3, OFFSET);
    ...
    const parent2 = createTransformNode("parent2", OFFSET - 4, 3, OFFSET);
    ...
    const parent4b = createTransformNode("parent4b", OFFSET + 2, 3, OFFSET);
