// Scene 265: Node Particle Editor — "Change - Color".
//
// Builds a Node Particle graph (a classic ParticleSystem with two color gradients, converted to NPE) and
...
async function main(): Promise<void> {
    ...
    const camera = createArcRotateCamera(-Math.PI / 2, 1.2, 12, { x: 0, y: 0.6, z: 0 });
