/** Scene 265 - NPE 'Change - Color' graph. Converted from a classic ParticleSystem with two color gradients
 * (addColorGradient(0, red) + addColorGradient(1, green)) via BABYLON.ConvertToNodeParticleSystemSetAsync
 * (mirrors Babylon.js visual test 'Particles - Change - Color', playground #AUPMMB#0). Checked-in scene data;
