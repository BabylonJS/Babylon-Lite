/** Scene 274 - NPE 'Animations 2' (sprite-sheet) graph. Converted from a classic sprite-sheet ParticleSystem
...
export const SCENE274_NPE_JSON = {
  "tags": null,
  "name": "npe",
  "editorData": null,
  ...
  "blocks": [
    ...
    {
      "customType": "BABYLON.BasicSpriteUpdateBlock",
      "id": 45,
      "name": "Sprite Cell Update",
      "visibleOnFrame": false,
      "inputs": [
        {
          "name": "particle",
