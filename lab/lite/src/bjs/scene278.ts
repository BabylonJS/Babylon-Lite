// Babylon.js reference for scene 278: the same serialized NPE flow-map graph and deterministic steps as Lite.
...
import { createScene278NpeJson } from "../shared/scene278-npe.js";
...
(async function () {
    ...
    const set = NodeParticleSystemSet.Parse(createScene278NpeJson());
