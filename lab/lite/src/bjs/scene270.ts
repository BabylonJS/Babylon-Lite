// BJS reference for scene 270 — a scene clip plane must slice both the
...
(async function () {
    ...
    const stdSphere = MeshBuilder.CreateSphere("scene270-standard-sphere", { segments: 32, diameter: 2.4 }, scene);
    ...
    const pbrSphere = MeshBuilder.CreateSphere("scene270-pbr-sphere", { segments: 32, diameter: 2.4 }, scene);
