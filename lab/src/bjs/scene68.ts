// BJS reference for scene 68 — mirrors the Lite scene exactly. Same NME JSON,
// same 4-light + env setup, plus a ClearCoatBlock connected to PBR-MR.clearcoat.
...
(async function () {
    ...
    const nm = NodeMaterial.Parse(SCENE68_NME_JSON, scene);
    nm.build(false);
    sphere.material = nm;
