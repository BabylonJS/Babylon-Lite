...
(async function () {
    ...
    await SceneLoader.AppendAsync("https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/Models/SheenWoodLeatherSofa/glTF-Binary/", "SheenWoodLeatherSofa.glb", scene);
