/** Scene 70 — Scene 67 + AnisotropyBlock (intensity=0 marker validation).
 *
 *  Adds an AnisotropyBlock with intensity=0 to PBR-MR.anisotropy. At
 *  intensity=0 the BJS anisotropic code path reduces to standard GGX
 *  (alphaT == alphaB == alphaG, bent normal == regular normal), so the
 *  visual output should match scene 67. This validates that AnisotropyBlock
 *  is wired through the parser, registry and emitter without breaking parity.
 *  Real anisotropic GGX (with non-zero intensity + tangent computation)
 *  will land alongside scene 72's full D8AK3Z snippet integration.
 */
export const SCENE70_NME_JSON = {
    ...
    blocks: [
        ...
        {
            customType: "BABYLON.InputBlock", id: 1, name: "position", target: 1,
            inputs: [], outputs: [{ name: "output" }],
            type: 8, mode: 1, systemValue: null, animationType: 0,
            isBoolean: false, matrixMode: 0, isConstant: false,
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        {
            customType: "BABYLON.InputBlock", id: 2, name: "normal", target: 1,
            inputs: [], outputs: [{ name: "output" }],
            type: 8, mode: 1, systemValue: null, animationType: 0,
            isBoolean: false, matrixMode: 0, isConstant: false,
            convertToGammaSpace: false, convertToLinearSpace: false,
        ...
        {
            customType: "BABYLON.InputBlock", id: 3, name: "worldViewProjection", target: 1,
            inputs: [], outputs: [{ name: "output" }],
            type: 128, mode: 0, systemValue: 6, animationType: 0,
            isBoolean: false, matrixMode: 0, isConstant: false,
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        {
            customType: "BABYLON.InputBlock", id: 4, name: "world", target: 1,
            inputs: [], outputs: [{ name: "output" }],
            type: 128, mode: 0, systemValue: 1, animationType: 0,
            isBoolean: false, matrixMode: 0, isConstant: false,
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        {
            customType: "BABYLON.InputBlock", id: 5, name: "cameraPosition", target: 2,
            inputs: [], outputs: [{ name: "output" }],
            type: 8, mode: 0, systemValue: 7, animationType: 0,
            isBoolean: false, matrixMode: 0, isConstant: false,
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        {
            customType: "BABYLON.InputBlock", id: 6, name: "baseColor", target: 2,
            inputs: [], outputs: [{ name: "output" }],
            type: 32, mode: 0, systemValue: null, animationType: 0,
            isBoolean: false, matrixMode: 0, isConstant: false,
            valueType: "BABYLON.Color3", value: [0.8, 0.8, 0.85],
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        {
            customType: "BABYLON.InputBlock", id: 7, name: "metallic", target: 2,
            inputs: [], outputs: [{ name: "output" }],
            type: 1, mode: 0, systemValue: null, animationType: 0,
            min: 0, max: 1, isBoolean: false, matrixMode: 0, isConstant: false,
            valueType: "number", value: 0,
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        {
            customType: "BABYLON.InputBlock", id: 8, name: "roughness", target: 2,
            inputs: [], outputs: [{ name: "output" }],
            type: 1, mode: 0, systemValue: null, animationType: 0,
            min: 0, max: 1, isBoolean: false, matrixMode: 0, isConstant: false,
            valueType: "number", value: 0.5,
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        // Vertex transform chain.
        {
            customType: "BABYLON.TransformBlock", id: 9, name: "TransformWVP", target: 1,
            inputs: [
        ...
        {
            customType: "BABYLON.TransformBlock", id: 10, name: "TransformWorldPos", target: 1,
            inputs: [
                { name: "vector", inputName: "vector", targetBlockId: 1, targetConnectionName: "output" },
        ...
        {
            customType: "BABYLON.TransformBlock", id: 11, name: "TransformWorldNormal", target: 1,
            inputs: [
                { name: "vector", inputName: "vector", targetBlockId: 2, targetConnectionName: "output" },
                { name: "transform", inputName: "transform", targetBlockId: 4, targetConnectionName: "output" },
            ],
            outputs: [{ name: "output" }, { name: "xyz" }],
            complementZ: 0, complementW: 0,
        },
        {
            customType: "BABYLON.VertexOutputBlock", id: 12, name: "VertexOutput", target: 1,
        ...
        {
            customType: "BABYLON.ReflectionBlock", id: 15, name: "Reflection", target: 4,
            inputs: [
        ...
        {
            customType: "BABYLON.InputBlock", id: 20, name: "ccIntensity", target: 2,
            inputs: [], outputs: [{ name: "output" }],
            type: 1, mode: 0, systemValue: null, animationType: 0,
            min: 0, max: 1, isBoolean: false, matrixMode: 0, isConstant: false,
            valueType: "number", value: 1.0,
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        {
            customType: "BABYLON.InputBlock", id: 21, name: "ccRoughness", target: 2,
            inputs: [], outputs: [{ name: "output" }],
            type: 1, mode: 0, systemValue: null, animationType: 0,
            min: 0, max: 1, isBoolean: false, matrixMode: 0, isConstant: false,
        ...
        {
            customType: "BABYLON.InputBlock", id: 22, name: "ccIor", target: 2,
            inputs: [], outputs: [{ name: "output" }],
            type: 1, mode: 0, systemValue: null, animationType: 0,
            min: 1, max: 3, isBoolean: false, matrixMode: 0, isConstant: false,
            valueType: "number", value: 1.5,
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        {
            customType: "BABYLON.ClearCoatBlock", id: 23, name: "ClearCoat", target: 4,
            inputs: [
        ...
        // ── Anisotropy parameters (scene 70 additions, intensity=0 marker) ──
        {
            customType: "BABYLON.InputBlock", id: 39, name: "uv", target: 1,
            inputs: [], outputs: [{ name: "output" }],
            type: 4, mode: 1, systemValue: null, animationType: 0,
            isBoolean: false, matrixMode: 0, isConstant: false,
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        {
            customType: "BABYLON.InputBlock", id: 40, name: "anisoIntensity", target: 2,
            inputs: [], outputs: [{ name: "output" }],
            type: 1, mode: 0, systemValue: null, animationType: 0,
            min: 0, max: 1, isBoolean: false, matrixMode: 0, isConstant: false,
            valueType: "number", value: 0.0,
        ...
        {
            customType: "BABYLON.InputBlock", id: 41, name: "anisoDirection", target: 2,
            inputs: [], outputs: [{ name: "output" }],
            type: 4, mode: 0, systemValue: null, animationType: 0,
            isBoolean: false, matrixMode: 0, isConstant: false,
            valueType: "BABYLON.Vector2", value: [1.0, 0.0],
            convertToGammaSpace: false, convertToLinearSpace: false,
        },
        {
            customType: "BABYLON.AnisotropyBlock", id: 42, name: "Anisotropy", target: 4,
            inputs: [
        ...
        // PBR-MR — scene 67 setup (no clearcoat / sheen) + anisotropy.
        {
            ...
            outputs: [
                { name: "ambientClr" }, { name: "diffuseDir" }, { name: "specularDir" },
                { name: "clearcoatDir" }, { name: "sheenDir" },
                { name: "diffuseInd" }, { name: "specularInd" },
                { name: "clearcoatInd" }, { name: "sheenInd" },
                { name: "refraction" }, { name: "lighting" }, { name: "shadow" }, { name: "alpha" },
            ],
            lightFalloff: 0,
            useAlphaTest: false, alphaTestCutoff: 0.4, useAlphaBlending: false,
            useRadianceOverAlpha: false, useSpecularOverAlpha: false,
            enableSpecularAntiAliasing: false, realTimeFiltering: false, realTimeFilteringQuality: 8,
            useEnergyConservation: true, useRadianceOcclusion: true, useHorizonOcclusion: true,
            unlit: false, forceNormalForward: false,
            debugMode: 0, debugLimit: 0, debugFactor: 1,
        },
        {
            customType: "BABYLON.FragmentOutputBlock", id: 14, name: "FragmentOutput", target: 2,
            inputs: [
